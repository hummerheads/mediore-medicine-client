  ...
  return (
    <div>
      ...
      <div className="flex md:flex-row flex-col md:justify-center">
        <div className="min-h-screen text-center md:w-1/5 bg-[#28A745] text-white font-bold text-xs md:text-2xl md:px-10 md:pt-20">
          ...
          <ul className="p-2 md:py-5 hover:bg-green-700">
            <div className="flex gap-2 justify-center flex-row-reverse md:gap-5 items-center">
