...
const UserDashboard = () => {
  ...
  return (
    <div className="w-full py-10 my-10 flex flex-col items-center justify-center min-h-screen bg-gray-100">
      <h1 className="text-lg md:text-4xl font-bold mb-5 text-[#28A745]">
        Welcome to Mediore!
      </h1>
      <h2 className="text-md md:text-2xl mb-10 text-gray-700">Your Personal Dashboard</h2>
      ...
      {userInfo ? (
        <div className="bg-white shadow-lg rounded-lg p-6 w-full max-w-md text-center">
          ...
          />
          <p className="text-lg md:text-3xl font-semibold">{userInfo.name}</p>
          <p className="text-md text-gray-600">{userInfo.email}</p>
          <p className="text-md text-gray-500 uppercase">{userInfo.role}</p>
